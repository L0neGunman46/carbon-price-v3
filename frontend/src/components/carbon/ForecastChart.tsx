...
const ANALYST_SOURCES: SourceKey[] = [
  "analyst_bnef",
  "analyst_refinitiv",
  "analyst_internal",
];
...
function buildChartData(
  ...
  hist.forEach((b, key) => {
    map.set(key, {
      date: key,
      historical: Math.round((b.sum / b.count) * 100) / 100,
    });
  });
      ...
      <div className="flex items-start justify-between mb-3">
        <div>
          ...
          <p className="text-xs text-gray-400 mt-0.5">
            Historical data + analyst forecasts. Click an analyst in the legend
            to auto-fill the table below.
          </p>
        </div>
